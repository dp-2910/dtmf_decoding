...
public class RecordingProvider extends ContentProvider {
    ...
    public int update(Uri uri, ContentValues values, String where, String[] whereArgs) {
        ...
        switch (uriMatcher.match(uri)) {
            case RECORDINGS:
                count = recordingsDB.update(RECORDINGS_TABLE, values,
                        where, whereArgs);
                break;
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case RECORDINGS:
                return "vnd.android.cursor.dir/vnd.talentcodeworks.callrecorder";
            case RECORDING_ID:
                return "vnd.android.cursor.item/vnd.talentcodeworks.callrecorder";
            default:
                throw new IllegalArgumentException("Unsupported URI: " + uri);
        }
    }
